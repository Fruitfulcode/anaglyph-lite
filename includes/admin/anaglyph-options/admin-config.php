	...
	class anaglyph_config {
                        ...
                        <a href="<?php echo wp_customize_url(); ?>" class="load-customize hide-if-no-customize"
                           title="<?php echo esc_attr( $customize_title ); ?>">
                            <img src="<?php echo esc_url( $screenshot ); ?>"
                                 alt="<?php esc_attr_e( 'Current theme preview', 'anaglyph-lite' ); ?>"/>
                        </a>
					<?php endif; ?>
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'global_variable'    => 'anaglyph_config',
				...
				'menu_icon'          => $source_path . 'anaglyph-icon.png',
				// Specify a custom URL to an icon
				'last_tab'           => '',
				// Force your panel to always open to a specific tab (by id)
				'page_icon'          => 'anaglyph-icon',
				// Icon displayed in the admin panel next to your menu_title
				'page_slug'          => 'anaglyph_options',
				...
				'footer_credit'      => '<span id="footer-thankyou">' . __( 'Anaglyph Options panel created using "Reduxe Framework".', 'anaglyph-lite' ) . '</span>',
				// Disable the footer credit of anaglyph. Please leave if you can help it.
		...
		public function admin_options_scripts() {
			...
			$inc_url = get_template_directory_uri() . '/includes/admin/anaglyph-options/patterns/';
			
			if ( ! empty( $current_screen->base ) && $current_screen->base === 'appearance_page_anaglyph_options' ) {
